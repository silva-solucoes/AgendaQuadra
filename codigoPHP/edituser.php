                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 mb-3">
                        <button type="button" class="btn btn-info" name="voltar" value="Voltar"
                            onclick="window.location.href='listcliente.php'">Voltar</button>
...
if (isset($_POST['alterar'])) {
    ...
    if (mysqli_affected_rows($conn)) {
        ...
        echo '<meta HTTP-EQUIV="Refresh" CONTENT="2; URL=listcliente.php">';
    } else {
        echo "<script>$(document).ready(function() { $('#msgErro').modal(); })</script>";
        echo '<meta HTTP-EQUIV="Refresh" CONTENT="2; URL=edituser.php">';
    }
}
?>